...
/// <reference path="Common/i-key-value-pair.d.ts" />
...
declare namespace Vidyano.WebComponents {
    class ActionButton extends WebComponent {
        ...
        readonly options: linqjs.KeyValuePair<number, string>[];
        private _setOptions;
...
declare namespace Vidyano.WebComponents {
    ...
    class App extends WebComponent {
        ...
        readonly profilerLoaded: boolean;
        ...
        attached(): void;
        detached(): void;
        private _onSessionStorage(event);
        ...
        private _importConfigs(configs, isAttached);
        private _updateInitialize(...promises);
        private _computeInitialService(uri, hooks, isAttached);
        ...
        private _computeShowMenu(application, noMenu, currentRoute);
        ...
        private _mediaQueryChanged(isDesktop, isTablet, isPhone);
...
declare namespace Vidyano.WebComponents.Attributes {
    class PersistentObjectAttributeAsDetail extends WebComponents.Attributes.PersistentObjectAttribute {
        ...
        readonly deleteAction: Vidyano.Action;
...
declare namespace Vidyano.WebComponents.Attributes {
    class PersistentObjectAttributeDateTime extends WebComponents.Attributes.PersistentObjectAttribute {
        ...
        readonly hasInvalidTime: boolean;
        ...
        private _computeMinMaxDate(date);
        private _previousMonth(e);
        private _nextMonth(e);
    }
}
declare namespace Vidyano.WebComponents.Attributes {
    class PersistentObjectAttributeDropDown extends WebComponents.Attributes.PersistentObjectAttribute {
        ...
        private _computeOrientation(attribute);
        private _computeGroupSeparator(attribute);
...
declare namespace Vidyano.WebComponents.Attributes {
    class PersistentObjectAttributeReference extends WebComponents.Attributes.PersistentObjectAttribute {
        ...
        private _computeOrientation(attribute);
        private _computeCanOpenSelect(isReadOnly, options);
...
declare namespace Vidyano.WebComponents.Attributes {
    class PersistentObjectAttributeValidationError extends WebComponents.WebComponent {
        attribute: Vidyano.PersistentObjectAttribute;
        private _computeHidden(validationError, isReadOnly);
...
declare namespace Vidyano.WebComponents.Attributes {
    class PersistentObjectAttribute extends WebComponent {
        ...
        private _computePlaceholder(attribute);
...
declare namespace Vidyano.WebComponents {
    ...
    class DatePicker extends WebComponent {
        ...
        private _isUnselectable(date, minDate, maxDate);
...
declare namespace Vidyano.WebComponents {
    class List extends WebComponent {
        ...
        private _hookIronListToScroller(parentScroller, isAttached);
...
declare namespace Vidyano.WebComponents {
    class Menu extends WebComponent {
        ...
        private _computeInstantSearchDelay(application);
        ...
        private _add(e);
        private _instantSearchResultMouseEnter(e);
    }
    class MenuItem extends WebComponent {
        ...
        private _isProgramUnitItemUrl(item);
...
declare namespace Vidyano.WebComponents {
    ...
    class MessageDialog extends Dialog {
        ...
        private _activeActionChanged(activeAction);
        private _keyboardNextAction();
        private _keyboardPreviousAction();
        private _isActiveAction(activeAction, index);
    }
}
declare namespace Vidyano.WebComponents {
...
declare namespace Vidyano.WebComponents {
    ...
    class PersistentObjectDialog extends Dialog {
        ...
        private _computeHideCancel(readOnly, noCancel);
...
declare namespace Vidyano.WebComponents {
    class PersistentObjectPresenter extends WebComponent implements IConfigurable {
        ...
        persistentObjectObjectId: string;
        persistentObject: Vidyano.PersistentObject;
        private _activate(e, {parameters});
...
declare namespace Vidyano.WebComponents {
    ...
    class PersistentObjectTabBarItem extends WebComponent {
        ...
        private _computeBadge(totalItems, hasMore);
...
declare namespace Vidyano.WebComponents {
    ...
    class QueryGridCellBoolean extends WebComponent {
        ...
        private _update(value, oldValue);
    }
}
declare namespace Vidyano.WebComponents {
...
declare namespace Vidyano.WebComponents {
    ...
    class QueryGridFilterDialogName extends WebComponent {
        ...
        name: string;
        attached(): void;
        private _attributeChanged(attribute);
        private _groupingChanged(grouping, previous?);
        private _toggleGrouping();
        private _updateAttributeValue(attribute, name, group);
    }
}
declare namespace Vidyano.WebComponents {
    class QueryGridFilters extends Vidyano.WebComponents.WebComponent {
        ...
        private _computeUserFilters(filters);
        private _computeLockedFilters(filters);
        private _computeFilters(filters, isLocked);
        private _catchGroupTap(e);
        private _nonGroupName(name);
        ...
        private _edit(e);
        private _delete(e);
        private _showUserFilterSeparator(canReset, canSave, canSaveAs);
        private _showLockedFilterSeparator(canReset, canSave, canSaveAs, userFilters);
        private _hasGroupName(filter);
        private _hasNoGroupName(filter);
    }
}
declare namespace Vidyano.WebComponents {
    class QueryGridSelectAll extends WebComponent {
        ...
        private _toggle();
        private _computePartial(selectedItems, allSelected, inverse);
        private _computeSelected(partial, allSelected);
    }
}
declare namespace Vidyano.WebComponents {
    ...
    class QueryGrid extends WebComponent {
        ...
        private _computeCanSelect(query, noSelection, asLookup);
...
declare namespace Vidyano.WebComponents {
    class Select extends WebComponent {
        ...
        private _computeHasOptions(options, readonly);
        private _computeUngroupedOptions(options, groupSeparator);
        private _computeItems(options, ungroupedOptions);
        ...
        private _isReadonlyInput(hasOptions, disableFiltering);
        private _disablePopup(readonly, disabled);
        private _showGroup(item);
    }
...
declare namespace Vidyano.WebComponents {
    ...
    class SignInProvider extends WebComponent {
        ...
        constructor(isVidyano: boolean, _isOnlyProvider: boolean, _returnUrl: string, _parameters: IProviderParameters);
        attached(): void;
        ...
        private _userNameErrorChanged(userNameError);
        private _userNameChanged();
        private _register();
        private _registerSave();
        private _registerCancel();
        private _showRegisterNotification(notification);
    }
}
declare namespace Vidyano.WebComponents {
...
declare namespace Vidyano.WebComponents {
    class SizeTracker extends WebComponent {
        ...
        measure(): void;
        private _onScroll(e);
        private _triggerSizeChanged(cr?);
...
declare namespace Vidyano.WebComponents {
    class User extends WebComponent {
        ...
        readonly canFeedback: boolean;
        private _setCanFeedback;
        readonly canUserSettings: boolean;
